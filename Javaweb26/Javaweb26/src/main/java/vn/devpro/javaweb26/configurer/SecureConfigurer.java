package vn.devpro.javaweb26.configurer;
...
import vn.devpro.javaweb26.service.UserDetailsServiceImpl;
...
//		 .defaultSuccessUrl("/admin/home", true) //login thanh cong thi vao trang home
		...
		.and().rememberMe().key("uniqueAndSecret").tokenValiditySeconds(86400);//không cần đăng nhập lại 
