		                            ...
		                            <div class="table-responsive">
	                               	...
	                               	<div class="row">
										...
										<div class="row">
											...
											<div class="col-md-1">
												<button id="btnSearch" name ="ntnSearch" type="submit" class="btn btn-primary">Search</button>
											</div>
										</div>
										<!-- Hết tìm kiếm -->
		                                    ...
		                                    <div class="pagination float-right">
			                                    ...
			                                    <c:choose>
				                                    ...
				                                    <c:otherwise>
				                                    	<li class="page-item">
				                                            <a class="page-link" 
				                                            	href="${classpath }/product-list/${currentPage-1}" tabindex="-1">Previous</a>
				                                        </li>
					                                    ...
					                                    <c:choose>
					                                    	...
					                                    	<c:when test="${index==currentPage }">
					                                        	<li class="page-item active"><a class="page-link" 
					                                        		href="${classpath }/product-list/${currentPage}">${currentPage }</a></li>
					                                        </c:when>
					                                        <c:otherwise>
					                                        	<li class="page-item"><a class="page-link" 
					                                        		href="${classpath }/product-list/${index }">${index }</a></li>
					                                        </c:otherwise>
			                                    ...
			                                    <c:choose>
			                                        ...
			                                        <c:otherwise>
				                                    	<li class="page-item">
				                                            <a class="page-link" 
				                                            	href="${classpath }/product-list/${currentPage+1}" tabindex="1">Next</a>
				                                        </li>
