                    ...
                    <div class="row">
                        <div class="col-12 col-lg-6">
                            ...
                            <div class="contact__form">
                                <sf:form class="form" action="/contact-list" method="post" modelAttribute="contact" enctype="multipart/form-data">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="contact__form-input">
                                                <sf:input path="txtName" type="text" class="form-input" 
                                        ...
                                        <div class="col-md-6">
                                            <div class="contact__form-input">
                                                <sf:input path="txtEmail" type="email" class="form-input" placeholder="Email..."
                                                		id="txtEmail" name="txtEmail" />
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="contact__form-input">
                                                <sf:input path="txtMobile" type="text" class="form-input" placeholder="Your mobile..."
                                                	id="txtMobile" name="txtMobile" />
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="contact__form-input">
                                                <sf:input path="txtAddress" type="text" class="form-input" placeholder="Your address..."
                                                	id="txtAddress" name="txtAddress" />
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <div class="contact__form-input">
                                                <sf:textarea path="txtMessage" cols="30" rows="5" class="form__textarea" id="txtMessage" name="txtMessage"
