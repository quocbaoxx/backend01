																...
																<tbody>
																	<c:forEach var="item" items="${cart.cartProducts }"
																		...
																		<tr>
																			...
																			<td align="center">
																				<button onclick="updateProductQuantity(${item.productId }, -1)" value="-">-</button> 
																				<strong><span
															...
															<div class="col-md-12">
																<div class="form-group mb-4">
																	<label for="name">Customer name (*)</label> <input
																		...
																		name="txtName" placeholder="your name" value="${user.name }"/>
																</div>
															</div>
														</div>
															...
															<div class="col-md-12">
																<div class="form-group mb-4">
																	<label for="mobile">Customer mobile (*)</label> <input
																		...
																		name="txtMobile" placeholder="your phone number" value="${user.mobile }" />
																</div>
															</div>
														</div>
															...
															<div class="col-md-12">
																<div class="form-group mb-4">
																	<label for="phone">Customer email</label> <input
																		...
																		name="txtEmail" placeholder="your email" value="${user.email }" />
																</div>
															</div>
														</div>
															...
															<div class="col-md-12">
																<div class="form-group mb-4">
																	<label for="phone">Customer address</label> <input
																		...
																		name="txtAddress" placeholder="your address" value="${user.address }" />
																</div>
															</div>
														</div>
														<div class="row">
															<div class="col-md-12">
																<div class="form-group mb-4">
																	<a href="${classpath }/index" class="btn btn-primary active" role="button"
								...
								<div class="col-12">
									<c:choose>
										<c:when test="${checkout }">
											<h3 align="center" 
												class="page-title text-truncate text-dark font-weight-medium mb-1">	
												<span id="placeOrderSuccess">Bạn đã đặt hàng thành công</span></h3>
										</c:when>
										<c:otherwise>
											<h3 align="center" 
												class="page-title text-truncate text-dark font-weight-medium mb-1">	
												<span id="placeOrderSuccess">Your cart: ${message }</span></h3>
										</c:otherwise>
									</c:choose>
